...
public class SunJaasKerberosClient implements KerberosClient {
	...
	public static class KerberosClientCallbackHandler implements CallbackHandler {

		private String username;

		private String password;

		KerberosClientCallbackHandler(String username, String password) {
